    ...
    <WrapperComponent classes={{ row: 'g-3' }} customCol={true}>
      ...
      >
        {dataAPI?.main_content?.section1_products?.status &&
          dataAPI?.main_content?.section1_products?.product_ids?.length >= 5 && (
            <ProductSection1
        ...
        {dataAPI?.main_content?.section2_slider_products?.status &&
          dataAPI?.main_content?.section2_slider_products?.product_ids?.length >= 5 && (
            <ProductSection4
              ProductData={filteredProduct}
        ...
        {dataAPI?.main_content?.section3_products?.status &&
          dataAPI?.main_content?.section3_products?.product_ids?.length >= 5 && (
            <ProductSection1
              ProductData={filteredProduct}
        ...
        {dataAPI?.main_content?.section4_products?.status &&
          dataAPI?.main_content?.section4_products?.product_ids?.length >= 5 && (
            <ProductSection1
              ProductData={filteredProduct}
