  ...
  return (
    ...
    >
      ...
      <Row className="g-sm-4 g-3">
        ...
        <Col
          xxl={
            (dataAPI?.deal_of_days?.status && dataAPI?.deal_of_days?.deals?.length) || 0 ? 8 : 12
          }
          lg={
            (dataAPI?.deal_of_days?.status && dataAPI?.deal_of_days?.deals?.length) || 0 ? 12 : 12
          }
        ...
        >
          <Row
            xl={3}
            lg={
              (dataAPI?.deal_of_days?.status && dataAPI?.deal_of_days?.deals?.length) || 0 ? 2 : 5
            }
            xxl={
              (dataAPI?.deal_of_days?.status && dataAPI?.deal_of_days?.deals?.length) || 0 ? 4 : 6
            }
            md={
              (dataAPI?.deal_of_days?.status && dataAPI?.deal_of_days?.deals?.length) || 0 ? 3 : 4
            }
            xs={2}
